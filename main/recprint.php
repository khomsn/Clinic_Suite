...
<br>
<div align="center"><input type="submit" name="OK" value="จ่าย" onClick="javascript:Clickheretoprint()" ></div>
<br><br>
...
<tr><td>
	...
	<table style="background-color: rgb(255, 204, 153); width:80%; text-align: center;
		...
		<tr><th>จ่าย</th><th width = 18% style='text-align:right;'><?php echo  $_SESSION['paytoday'];?>
		</th></tr>
	</table>
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;รับเงินโดย:
