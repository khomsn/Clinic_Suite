...
<iframe src="../cashier/recprintpv.php"  id="MidIframe" onload="iframeLoaded()" scrolling="no" frameborder="0"  width="71%" style="float:none;" name="MAIN"></iframe>
<iframe src="rmenureg.php" id="RightIframe" onload="iframeLoaded()" scrolling="no" frameborder="0"  max-width='150px' width="14%" style="float:right;" name="rmenu"></iframe>
</body>
</html>
