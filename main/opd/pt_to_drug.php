...
function timingLoad() {
$('#main').load('updateptdr.php #main', function() {
...
<tr><td width="160" valign="top">
    ...
    ?>
        ...
        ?>
        <a href="../cashier/patcash.php
        <?php echo "?msg=".$msg; ?>"><?php echo $row['id'];?></a>

        <?php 
        echo "</th><th>"; 
        echo "<a href=../cashier/patcash.php?msg=".$msg.">".$row['prefix']."</a>";
        echo "</th><th width=150>"; 
        echo "<a href=../cashier/patcash.php?msg=".$msg.">".$row['fname']."</a>";
        echo "</th><th width=150>"; 
        echo "<a href=../cashier/patcash.php?msg=".$msg.">".$row['lname']."</a>";
        echo "</th><th>";
        ?><div class="avatar">
