...
<iframe src="labfpage.php" onload="this.height=window.innerHeight-20;" width="68%" frameborder="0" style="float:none;" name="MAIN"></iframe>
<iframe src="rlabmenubar.php" onload="this.height=window.innerHeight-20;" width="15%" frameborder="0" style="float:right;" name="rmenu"></iframe>
</body>
</html>